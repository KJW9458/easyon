var pinBoard = (function($) {
	var pinBoardCover,
		...
		optionColor = ["#34495e", "#ecf0f1", "#bdc3c7", "#95a5a6", "#7f8c8d", "#2ecc71", "#27ae60", "#3498db", "#2980b9", "#9b59b6", "#8e44ad", "#f1c40f", "#f39c12", "#e67e22", "#d35400",
				"#e74c3c", "#c0392b"];
	...
	*/
	...
	var Environment = {
		...
		toolTemplate : function() {
			var content = "";
				content +='<div>'+
					...
					'<input type="range" class="range" min="1" max="10" value="1" />'+
		...
		canvasTemplate : function() {
			...
			return '<canvas id="canvas" width="'+($('.pinBoard').width()-30)+'" height="'+($('.pinBoard').height()-30)+'"></canvas>';
		},
